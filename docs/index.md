...
!!! info
    ...
    **Source Code Repository:** [https://github.com/fpetk-rolling-demo/chatbot-test-17](https://github.com/fpetk-rolling-demo/chatbot-test-17)

    **GitOps Repository:** [https://github.com/fpetk-rolling-demo/chatbot-test-17-gitops](https://github.com/fpetk-rolling-demo/chatbot-test-17-gitops)

# **Usage**

To access the chatbot-test-17 application that was deployed using the Software Template, complete the following instructions:
